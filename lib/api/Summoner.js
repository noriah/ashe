...
function getSummonersById (region, summonerIds) {
  var requestParams = {
    ...
    cache: {
      ttl: TTL_SUMMONER_ID,
      keyFn: summonerId => `summoner:byId:${summonerId}`,
      saveIfNull: true
    }
  }
...
function getSummonersMasteries (region, summonerIds) {
  var requestParams = {
    ...
    cache: {
      ...
      keyFn: summonerId => `summoner:masteries:${summonerId}`,
      saveIfNull: true
    }
  }
...
function getSummonersNames (region, summonerIds) {
  var requestParams = {
    ...
    cache: {
      ttl: TTL_SUMMONER_ID,
      keyFn: summonerId => `summoner:name:${summonerId}`,
      saveIfNull: true
    }
  }
...
function getSummonersRunes (region, summonerIds) {
  var requestParams = {
    ...
    cache: {
      ...
      keyFn: summonerId => `summoner:runes:${summonerId}`,
      saveIfNull: true
    }
  }
